...
/**
 * This is meant to be an extremely simple GC parser, only to be used for exercises.
 * TODO: refactor out the format of parsed verbose gc output (this version works on Win only).
 */
